...
CMD ["sh", "-c", "if [ \"$ENVIRONMENT\" = \"development\" ]; then python -m debugpy --listen 0.0.0.0:5678 manage.py runserver 0.0.0.0:8000; else python manage.py runserver 0.0.0.0:8000; fi"]